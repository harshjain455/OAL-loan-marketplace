...
import { 
  ...
  Clock, User, LogOut, ChevronDown, Settings, ChevronLeft, ChevronRight, PanelLeft, PanelLeftClose 
} from "lucide-react";
...
export default function NetworkLayout() {
  ...
  const userRole = localStorage.getItem("oal_user_role") || "network";
  const userEmail = localStorage.getItem("oal_user_email") || "network@gmail.com";
  const userName = localStorage.getItem("oal_user_name") || "Network Stream Viewer";
        ...
        <header className="flex items-center justify-between h-16 px-6 bg-slate-900 border-b border-slate-800 relative z-30">
          ...
          <div className="relative ml-auto">
            ...
            >
              ...
              <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-purple-600/20 border border-purple-500/30 text-purple-400 font-bold group-hover:bg-purple-600 group-hover:text-white transition-all">
                <User size={18} />
              </div>
