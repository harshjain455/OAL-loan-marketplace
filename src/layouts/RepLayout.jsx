...
import { 
  Menu, X, Home, Users, Bell, Eye, FileText, Heart, MessageSquare, 
    ...
    <div className="flex h-screen bg-slate-950 text-slate-100 overflow-hidden font-sans">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-800 bg-slate-900">
          {!isCollapsed ? (
            <span className="text-xs font-bold tracking-wider text-slate-50 uppercase truncate">OAL REPS PORTAL</span>
          ) : (
            <span className="text-xs font-bold tracking-wider text-blue-400 uppercase mx-auto">OAL</span>
          )}
        ...
        <div className="p-3 border-t border-slate-800 mt-auto">
          <Link
            ...
            className={`flex items-center ${
              isCollapsed ? "justify-center px-2" : "px-4"
            } py-3 text-sm font-medium text-red-400 rounded-lg hover:bg-red-500/10 hover:text-red-300 transition-colors group`}
          >
        ...
        <header className="flex items-center justify-between h-16 px-6 bg-slate-900 border-b border-slate-800">
          ...
          <div className="flex items-center ml-auto space-x-4">
            ...
            <Link
              ...
              title="View Profile"
            >
              <span className="text-xs font-semibold text-slate-300">OAL Rep / Agent</span>
